...
<div class="mov"><form action="http://localhost/Takeoff/home/Search/avail.php#" method="post"><button name="contact" value="1" style="background:black;color:yellow;padding:10px;border:0 solid black;opacity:8.9;"><a href=""><i class="fas fa-3x fa-times"></i></a></button></form></div>
<br><br>
